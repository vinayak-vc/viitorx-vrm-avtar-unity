...
- **Status:** In progress (2026-08-06). Runtime = Sentis (ONNX Runtime fallback if op-support fails). Model = **RTMW3D** (POC/non-commercial). Feasibility spike underway: model downloaded, Sentis import test PENDING.
